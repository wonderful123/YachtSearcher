...
# Base spider moves setting of command line arguments out of spider and database
# Loading
...
class BaseSpider(scrapy.Spider):
    def __init__(self, *args, **kwargs):
        ...
        self.scrape_location = int(self.scrape_location) if hasattr(self, 'scrape_location') else 'false'
